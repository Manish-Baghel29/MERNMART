...
function PlaceOrder() {
  ...
  return (
    <div className='w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-center flex-col md:flex-row gap-[50px]  relative'>
        ...
        <div>
          <button type='submit' className='text-[18px] active:bg-slate-500 cursor-pointer bg-[#3bcee848] py-[10px] px-[50px] rounded-2xl text-white flex items-center justify-center gap-[20px] absolute lg:right-[17%] bottom-[10%] right-[35%] border-[1px] border-[#80808049] ml-[35px] mt-[20px]' >{loading? <Loading/> : "PLACE ORDER"}</button>
         </div> 
            </form>
        ...
        <div className='w-[100%] h-[30vh] lg:h-[100px] flex items-start mt-[15px] lg:mt-[0px] justify-center gap-[50px]'>
